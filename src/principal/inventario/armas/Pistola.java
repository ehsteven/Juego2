...
public class Pistola extends Arma{
    ...
    public Pistola(int id_x, int id_y, String nombre, String descripcion, int ataqueMin, int ataqueMax, boolean automatica, boolean penetrante, double ataquesPorSeg) {
